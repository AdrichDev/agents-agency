...
export const SERVICE_CATALOG: ServiceEntry[] = [
  ...
  { id: "chatbot_plus", name: "Agente IA — Plus", description: "Página Web + Agente IA Multi-canal + cobertura Google + Hosting", implPrice: 990, maintPrice: 99 },
  { id: "chatbot_pro", name: "Agente IA — Pro", description: "Agente autónomo con integraciones avanzadas, voz, RAG", implPrice: 2400, maintPrice: 149 },
  ...
  { id: "web_chatbot", name: "Web Completa + Chatbot", description: "Web corporativa con agente IA integrado y multi-idioma. Incluye CRM, base de conocimiento, automatizaciones y analytics.", implPrice: 2730, maintPrice: 180 },
