...
export default function AvisoLegalPage() {
  return (
    <>
      ...
      <p>El tratamiento de datos personales se regula en la <strong>Política de Privacidad</strong>. La utilización de cookies y tecnologías similares se explica en la <strong>Política de Cookies</strong>. Ambos documentos forman parte de la información legal del sitio web.</p>
